      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-[360px] sm:w-[440px] h-[520px] bg-[#06080b]/95 border-2 border-cyan-500/40 rounded-2xl shadow-[0_0_40px_rgba(6,182,212,0.25)] backdrop-blur-xl flex flex-col overflow-hidden text-left"
          >
            ...
            {activeChannel === 'PRIVADO' && activeDmPartner ? (
              <div className="px-3 py-1.5 bg-cyan-950/40 border-b border-cyan-500/30 flex items-center justify-between font-mono">
              ...
              <div className="px-3 py-1.5 bg-black/40 border-b border-cyan-950/60 relative">
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-3 font-mono text-[9.5px] scrollbar-thin scrollbar-thumb-cyan-950">
              ...
              {/* VISTA A: LISTA DE CONVERSACIONES PRIVADAS (RESTRICCIONES Y BORRADO DE CHATS) */}
              {activeChannel === 'PRIVADO' && !activeDmPartner ? (
                  ...
                  {recentDmPartners.length === 0 ? (
                    ...
                    recentDmPartners.map((partner) => (
                      ...
                      >
                        ...
                        {/* BOTÓN ABRIR DM + BOTÓN ELIMINAR CONVERSACIÓN DE LA LISTA */}
                ...
                filteredMessages.length === 0 ? (
                  ...
                  filteredMessages.map((msg) => (
                    <div key={msg.id} className="flex gap-2.5 items-start group text-left relative">
                      ...
                      {/* MENÚ DE OPCIONES VINCULADO AL ID ÚNICO DE MENSAJE (SIN DUPLICACIÓN) */}
            ...
            <AnimatePresence>
              {showEmojiPicker && (
                <motion.div
                  ...
                  className="p-2.5 bg-neutral-950/95 border-t border-cyan-500/40 grid grid-cols-8 gap-1.5 text-center text-sm font-mono backdrop-blur-md relative z-40"
                >
            ...
            <form onSubmit={handleSend} className="p-2.5 bg-black/90 border-t border-cyan-900/50 flex items-center gap-2">
              <button
                type="button"
