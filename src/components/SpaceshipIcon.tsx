...
export const SpaceshipIcon: React.FC = () => {
  return (
    <div className="relative w-full h-full flex items-center justify-center p-4 select-none">
      ...
      {/* Futuristic spacecraft core hull vector rendering (highly inspired by user reference) */}
      <div className="relative w-52 h-52 md:w-60 md:h-60 flex items-center justify-center">
        ...
        >
          ...
          {/* THRUST PLASMA PLUMES (Twin Propulsion fire streams) */}
          ...
          {/* SPACESHIP GEOMETRY (Drawn carefully inspired by the reference image wings and thruster bays) */}
          ...
          {/* 7. Holographic Neon Pink Canopy Glass (Cockpit) */}
          ...
          {/* 8. Fore and Wingtip Laser Emitters */}
